...
public class TERenderer {
    ...
    public void drawTiles(TETile[][] world, List<LightenBlock> lightenBlocks) {
        for (LightenBlock lightenBlock : lightenBlocks) {
            world[lightenBlock.getX()][lightenBlock.getY()].draw(lightenBlock.getX() + xOffset, lightenBlock.getY() + yOffset);
        }
    }
